...
from pgm.utils_pgm import check_nan, calculate_loss
...
class DSCM(nn.Module):
    ...
    def forward(self, obs, do, elbo_fn, cf_particles=1):
        ...
        # As segmentation volumes are all continuous values, we do not use soft labels.
        pred_batch = self.predictor.predict_volumes(**cfs)
