...
beta=3
exp_name="mimic_224_224_segmentor_rand_train_batch_beta_${beta}_soft_lr_1e4_lagrange_lr_1_damping_10"
...
srun python train_cf_segmentor.py \
    ...
    --wd=0.05 \
    --eval_freq=1 \
    --predictor_path='../pgm/checkpoints/Left-Lung_volume_Right-Lung_volume_Heart_volume/sup_aux_mimic_224_224_segmentor/checkpoint.pt' \
    --pgm_path='../pgm/checkpoints/Left-Lung_volume_Right-Lung_volume_Heart_volume/sup_pgm_mimic_224_224_segmentor/checkpoint.pt' \
