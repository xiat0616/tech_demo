...
from causal_models.dscm.dscm_segmentor import DSCM, vae_preprocess
...
from causal_models.pgm.chest_pgm_segmentor import FlowPGM_with_seg as FlowPGM
...
def cf_epoch(args, model, ema, dataloaders, elbo_fn, optimizers, split='train', is_train=None):
    ...
    for i, batch in loader:
        ...
        if is_train:
            ...
            with torch.no_grad():
                preds_cf = ema.ema_model.predictor.predict_volumes(**out['cfs'])
