...
from causal_models.hvae2 import HVAE2
# from causal_models.hvae4_attn import HVAE4_attn
...
def main(args):
    ...
    model = HVAE2(args) 
    # model = HVAE3(args) if args.lambda_cr else HVAE2(args) 
    ...
    if args.resume:
        if os.path.isfile(args.resume):
            ...
            for g in optimizer.param_groups:
                g["lr"] = args.lr
                g["wd"] = args.wd # Reset wd of the loaded optimizer
